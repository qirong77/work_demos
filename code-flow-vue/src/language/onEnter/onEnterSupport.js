 ...
 *--------------------------------------------------------------------------------------------*/
import { IndentAction } from "../editor/indentAction.js";
import {monarchs} from "../basicLanguages/index";
export class OnEnterSupport {
  constructor(languageId) {
    let opts = monarchs[languageId].conf;
    opts = opts || {};
  ...
  onEnter(autoIndent = 3, previousLineText, beforeEnterText, afterEnterText) {
    // (1): `regExpRules`
